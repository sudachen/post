...
func ScryptPositions(id, salt []byte, startPosition, endPosition uint64, options Options, hashLenBits uint8) ([]byte, error) {
...
func GPUCount(onlyAvailable bool) int {
	return cGPUCount(onlyAvailable)
}
